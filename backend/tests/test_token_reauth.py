...
Covers refresh_spotify_token branching on 400 invalid_grant vs. other
transient failures (Task 1).

Outbound Spotify HTTP calls are mocked via respx. asyncio_mode = "auto"
