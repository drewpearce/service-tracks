...
def upgrade() -> None:
    ...
    op.add_column('church', sa.Column('playlist_name_template', sa.Text(), nullable=False, server_default=r'{church_name} Worship'))  # noqa: E501
    op.add_column('church', sa.Column('playlist_description_template', sa.Text(), nullable=False, server_default=r'Worship set for {date}'))  # noqa: E501
