      ...
      <div className="relative flex flex-col justify-between p-12 w-full">
        ...
        <div className="max-w-lg">
          ...
          <h1 className="font-display text-[44px] leading-[1.05] font-semibold tracking-tight">
            Every worship plan,
            <br />
            <span className="text-teal-400">on every platform</span>.
          </h1>
          <p className="mt-6 text-[15px] text-slate-300 leading-relaxed">
            Keep your team's rehearsal playlist in lockstep with Planning Center. Add a song,
            change the set list, swap a team — your Spotify and YouTube Music playlists update
            automatically.
          </p>
        </div>
      ...
      <div className="flex flex-1 flex-col lg:w-1/2">
        ...
        <header className="flex items-center justify-between px-10 py-6">
          ...
          <div className="ml-auto text-[13px] text-slate-500">
            New here?{" "}
            <Link to="/register" className="font-medium text-slate-900 hover:text-teal-600">
              Create an account →
            </Link>
          </div>
        </header>
          ...
          <div className="w-full max-w-sm">
            <div className="mb-8">
              ...
              <p className="mt-2 text-[14px] text-slate-500">
                Sign in to sync your Sunday set list.
              </p>
            </div>
